...
class RaidLogsCog(commands.Cog):
    ...
    async def _run_main_automation(self, guild: discord.Guild, entry: dict, who_label: str, tier_guess, is_auto: bool):
        ...
        # AttendanceCog._refresh_overview_message itself mirrors this to
        # MODERATOR_CHANNEL_ID (if configured) since it's given a real
        # updated_by here - same as a manual button click or
